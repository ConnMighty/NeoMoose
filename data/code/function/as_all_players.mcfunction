...
execute as @s[tag=!gotnav] run function code:got_nav
...
execute unless score @s died matches 0.. run scoreboard players set @s died 0
...
execute if score @s default_visitor_gamemode matches 1.. run function code:default_visitor_gamemode_switch with storage temp
...
execute if score @s allow_visits matches 1.. run function code:allow_visits_switch with storage temp
...
execute if score @s allow_visitor_block_interactions matches 1.. run function code:allow_visitor_block_interactions_switch with storage temp
...
execute if items entity @s player.cursor diamond[item_name="See All Commands"] run clear @s diamond[item_name="See All Commands"]
execute if items entity @s container.* diamond[item_name="See All Commands"] run clear @s diamond[item_name="See All Commands"]
...
execute if items entity @s player.cursor diamond[item_name="See All Selectors"] run clear @s diamond[item_name="See All Selectors"]
execute if items entity @s container.* diamond[item_name="See All Selectors"] run clear @s diamond[item_name="See All Selectors"]
