...
execute unless items entity @s weapon.offhand writable_book run return run tellraw @s {color:red,italic:1b,text:"Write the name of an item for your world icon in a book and quill, then hold it in your offhand and run this command again!"}
